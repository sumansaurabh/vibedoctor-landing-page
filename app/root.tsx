...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const amplitudeInitScript = `window.amplitude.add(window.sessionReplay.plugin({sampleRate: 1}));window.amplitude.init(${JSON.stringify(amplitudeApiKey)}, {"autocapture":{"elementInteractions":true, "attribution": true}, "cookieDomain": ".vibedoctor.dev"});`;
