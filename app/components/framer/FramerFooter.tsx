      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://discord.gg/35n7yZta" target="_blank" rel="noopener noreferrer" className="text-white/30 transition-colors hover:text-white/60" aria-label="Discord">
